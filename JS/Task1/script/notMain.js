let count_elements = document.getElementById('input').value;
function Fibo() {
    const f = (function * () {
      const A = [ 0, 1 ];
      let forward = true;
  ...
  let forward = document.getElementById('directForward');
  let back = document.getElementById('directBack');
   let button = document.getElementById('butInp');
